  ...
  contentBlocks: [
    ...
    },
    {
      ...
      content: {
        ...
        columns: 3,
        items: [
          { icon: '⚡', title: 'Fast & Easy Video Creation', description: 'Create stunning videos in minutes, not hours' },
          { icon: '🎨', title: 'Professional Quality', description: 'Cinematic AI-generated visuals every time' },
          { icon: '🎬', title: 'Full Creative Control', description: 'Custom prompts, voices, music & captions' }
        ]
      },
      order: 1
    }
