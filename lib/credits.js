...
const DEFAULT_CREDIT_COSTS = {
  ...
  // Video Processing - AI Video uses 200 credits base for 30s
  'video-editor': 60,
  'ai-video-studio': 200,   // AI video: 200 credits base for 30s
  'quick-reels': 25,        // Stock videos only - low cost (Pexels is free)
  'quick-reels-stock': 25,  // Stock videos - very low cost
  'quick-reels-ai-essential': 150,    // AI Essential tier
  'quick-reels-ai-standard': 200,     // AI Standard tier
  'quick-reels-ai-professional': 250, // AI Professional tier
  'quick-reels-ai-cinema': 300,       // AI Cinema Quality
  'auto-subtitles': 40,
  'auto-reels': 200,        // AI video: 200 credits base for 30s
  'auto-longform': 250,     // AI video: 250 credits base for 30s
  'talking-head': 200,      // AI video: 200 credits base for 30s
  'transformation-video': 200, // AI video: 200 credits base for 30s
  'script-to-ad': 200,      // AI video: 200 credits base for 30s
  'story-reels': 200,       // AI video: 200 credits base for 30s
...
export async function deductCredits(userId, toolId, params = {}) {
  ...
  if (user?.role === 'admin') {
    ...
    // Create a transaction record WITH actual cost for tracking
    await db.collection('credit_transactions').insertOne({
      _id: transactionId,
      userId,
      toolId,
