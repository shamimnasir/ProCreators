...
const DEFAULT_CREDIT_COSTS = {
  ...
  // Video Processing (Dynamic cost based on video source)
  'video-editor': 60,
  'ai-video-studio': 80, // Base cost - adjusted by video source
  'quick-reels': 25,     // Stock videos only - low cost (Pexels is free)
  'quick-reels-stock': 25, // Stock videos - very low cost
  'quick-reels-ai-essential': 50,   // AI Essential tier (~$0.04/video)
  'quick-reels-ai-standard': 70,    // AI Standard tier (~$0.05/sec)
  'quick-reels-ai-professional': 100, // AI Professional tier (~$0.07/sec)
  'quick-reels-ai-cinema': 150,     // AI Cinema Quality (~$0.20/sec)
  'auto-subtitles': 40,
  'auto-reels': 80,
  'auto-longform': 100,
  'talking-head': 90,
