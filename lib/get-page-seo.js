...
const DEFAULT_SEO = {
  homepage: {
    ...
    metaDescription: 'Create viral content, ebooks, videos, and more with AI',
    keywords: 'AI content creation, viral content, ebooks, videos, AI tools'
  },
  about: {
    ...
    keywords: 'about procreators, AI content platform, content creation company'
  },
  privacy: {
  ...
  pricing: {
    metaTitle: 'Pricing | ProCreators',
    metaDescription: 'Simple, transparent pricing for ProCreators. Start free, upgrade when you need more.',
    keywords: 'pricing, plans, subscription, credits'
  },
  blog: {
    metaTitle: 'Blog | ProCreators',
    metaDescription: 'Tips, tutorials, and insights on content creation with AI.',
    keywords: 'blog, tutorials, tips, AI content, guides'
  },
  docs: {
  ...
  tools: {
    metaTitle: 'All AI Tools | ProCreators',
