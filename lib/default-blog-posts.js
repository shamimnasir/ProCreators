...
Once you've picked a niche, use ProCreators to go from idea to Amazon-ready PDF in under 30 minutes. [Start with the Planner Maker, Journal Maker, or Ebook Creator →](/tools?category=publishing)
`
  },
  {
...
`
  ...
  {
    postId: 'amazon-kdp-requirements-guide',
    slug: 'amazon-kdp-requirements-guide-2026',
    title: 'The Complete Amazon KDP Requirements Guide (2026)',
    excerpt: 'Every KDP rule, dimension, file spec, and content policy you need to publish a book that Amazon will accept the first time — updated for 2026.',
    coverImage: coverFor('amazon-kdp-requirements-guide-2026'),
    category: 'KDP Publishing',
    tags: ['KDP', 'Amazon', 'Requirements', 'Formatting'],
    author: 'ProCreators Team',
    featured: true,
    ...
    published: true,
    seo: {
      metaTitle: 'Amazon KDP Requirements Guide (2026): Every Rule, Every Dimension',
      metaDescription: 'The complete 2026 Amazon KDP requirements checklist: file formats, cover dimensions, trim sizes, content policies, AI disclosure, ISBN rules, and royalty tiers.',
      keywords: 'kdp requirements, amazon kdp rules, kdp cover size, kdp trim size, kdp file format, kdp ai disclosure 2026'
    },
    content: `# The Complete Amazon KDP Requirements Guide (2026)

Amazon Kindle Direct Publishing (KDP) is generous — you can publish almost anything from a novel to a puzzle book to a spreadsheet template. But if you break a formatting or content rule, your book gets rejected, sometimes without a clear reason. This guide walks through every KDP requirement you actually need to know in 2026.

## 1. Account requirements

Before you upload a single file:

- **Region**: KDP is open in 40+ countries. You'll pay taxes in your home country and Amazon files a US W-8BEN or W-9 for you.
- **Bank account**: Required for direct-deposit royalty payments. Amazon supports most major banks including USD, EUR, GBP, JPY, INR, and more.
- **Tax interview**: Complete Amazon's short tax questionnaire during signup. Skipping it withholds 30% of your royalties.
- **Author name**: You can publish under a pen name — Amazon does not require a legal name on the book.

You only need one KDP account no matter how many pen names you publish under.

## 2. Ebook (Kindle) requirements

### Accepted upload formats

- **EPUB** (recommended in 2026 — Amazon converts internally)
- **DOCX** (Amazon converts to Kindle format)
- **KPF** (from Kindle Create app)
- **HTML zipped folder**
- **MOBI is deprecated** — do NOT upload .mobi files anymore

Use ProCreators' [Ebook Creator](/dashboard/tools/ebook-maker) to export directly to EPUB with proper table-of-contents linking.

### Ebook cover

- Format: **JPG or TIFF** (JPG recommended)
- Dimensions: **1600×2560 pixels** (2.5:1.6 ratio) is the modern standard
- Minimum: 1000×1600 pixels
- DPI: 300
- Color space: RGB (Amazon converts to grayscale for e-ink previews automatically)
- File size: under 50 MB

### Ebook interior

- Fonts must be embedded (EPUB handles this automatically)
- No fixed-width layouts unless you specifically enable "Fixed Layout" (for children's picture books or cookbooks with images)
- Hyperlinks: fine
- Videos or interactive elements: not supported on standard Kindle

## 3. Paperback requirements

### Accepted upload formats

- **PDF** (only accepted format for paperback interior). ProCreators, Canva, InDesign, Google Docs (via export), and Word all output valid PDFs.

### Standard trim sizes

The most common trim sizes on Amazon KDP paperbacks in 2026:

| Trim size | Best for |
|---|---|
| 5" × 8" | Novels, self-help, small journals |
| 5.25" × 8" | Novels (slightly wider gutter) |
| 5.5" × 8.5" | Poetry, gift books |
| 6" × 9" | Non-fiction, self-help, planners |
| 7" × 10" | Workbooks, activity books |
| 8" × 10" | Children's picture books, cookbooks |
| 8.5" × 11" | Journals, planners, workbooks (US Letter) |
| 8.5" × 8.5" | Square children's books |

Choose ONE trim size before you design the interior. Changing it later requires redoing the entire layout.

### Paperback margins

- **Outside margins** (top, bottom, outside): minimum 0.25" (0.635 cm)
- **Gutter (inside/spine margin)**: scales with page count
  - 24–150 pages: 0.375"
  - 151–300 pages: 0.5"
  - 301–500 pages: 0.625"
  - 501–700 pages: 0.75"
...
If you don't include a proper gutter, text near the spine will disappear into the binding.

### Paperback cover

Paperback covers are a SINGLE flat PDF that includes:

1. Back cover (left side)
2. Spine (center — width depends on page count)
3. Front cover (right side)

Amazon provides a free cover template generator at [kdp.amazon.com](https://kdp.amazon.com) — plug in your trim size and page count, download the template, and design over it.

- Format: **PDF**
- Color space: **CMYK** (not RGB) for print
- Bleed: **0.125" on all outer edges** (color must extend past the trim line)
- DPI: 300

### Page count

- **Minimum**: 24 pages
- **Maximum**: 828 pages (interior)

## 4. Hardcover requirements

Hardcover launched wide on KDP in 2023. Requirements are nearly identical to paperback, with these differences:

- Cover is printed with a matte or gloss laminate (Amazon chooses based on trim size)
- Add 0.125" more to the gutter than paperback at every page-count tier
- No dust jackets — you get a printed hardcover only
...
- Max: **200 characters**
- Cannot contain: pricing information, promotional statements ("bestseller", "free"), other authors' names, or ASINs
- Should include the primary keyword, then a benefit or category descriptor

### Subtitle

- Optional, max 200 characters combined with title
- Cannot repeat words from the title
- Best practice: state the specific benefit or audience ("A 30-Day Habit Tracker for Busy Moms")

### Description

- Max: **4,000 characters**
- Basic HTML allowed: **<b>**, **<em>**, **<br>**, **<p>**, and lists
- Amazon strips: **<script>**, **<a>** (external links), styling tags
- Best practice: open with hook, then bullet-list of benefits, then social proof + CTA

### Author name

- One primary author + up to 8 contributors
- Cannot be a pseudonym implying a real celebrity ("J K Rowling Jr." — not allowed)
- Can be a pen name that is clearly fictional

### Keywords

- Exactly **7 keyword slots** (each up to 50 chars)
- These are search phrases, not single words. Use "printable planner for teachers" not "planner"
- Do NOT: repeat words already in the title, list competitor names, use promotional terms

### Categories

- **Choose 2 primary categories** (was 10 briefly in 2023, reverted to 2 in 2024)
- Amazon then auto-assigns your book to up to 10 total based on keywords + browse path
- Best practice: pick the LEAST competitive relevant sub-categories, not the biggest

## 6. AI disclosure requirement (mandatory in 2026)

Since Q4 2023, Amazon requires all KDP uploaders to disclose whether content is AI-generated. In 2026 this is enforced strictly.

Two options at upload time:

- **AI-generated**: content came from AI with minimal editing
- **AI-assisted**: you created the work and used AI for parts (grammar, image variations, brainstorming)

For most publishers using ProCreators (where you provide the topic, edit, and finalize), the honest answer is **AI-assisted**.

Disclosure is a single click. It does NOT affect ranking, royalties, or search visibility. Failing to disclose risks account suspension.

## 7. ISBN rules

- Ebooks: **Amazon assigns a free ASIN**. You do NOT need to buy an ISBN.
- Paperbacks: Amazon offers a **free KDP-only ISBN** OR you can bring your own ISBN (Bowker in the US, Nielsen in the UK).
- **KDP-supplied ISBNs cannot be used outside Amazon**. If you want to sell on IngramSpark, Barnes & Noble, or Kobo, buy your own ISBN.

## 8. Royalty tier eligibility

Amazon pays two ebook royalty rates:

- **35% royalty**: ebook price < $2.99 OR > $9.99
- **70% royalty**: ebook price between $2.99 and $9.99
  - + your ebook must be enrolled in **KDP Select** (Amazon-exclusive for 90 days)
  - + your file size incurs a small delivery fee (~$0.15/MB)

Paperback royalty is 60% of list price minus printing cost. Do NOT enroll paperbacks in Select — it's ebook-only.

## 9. Content that Amazon rejects

Amazon will remove a book (sometimes without notice) if it contains:

- **Copyright infringement**: Disney characters, sports team logos, celebrity images, K-pop group names in the title (in the interior is fine), quoted lyrics without a license, translated public-domain works you didn't translate yourself.
- **Public domain content resold as new**: republishing Shakespeare, the Bible, or free-to-web content as an original book gets flagged.
- **Duplicate content**: publishing the same book under multiple ASINs or spinning content across dozens of near-identical books.
- **Misleading content**: books whose interior doesn't match the promise on the cover.
- **Poor customer experience**: books under 24 pages, low-effort AI content with obvious errors, or books that are just link farms.
- **Hate speech, illegal content, deceptive medical advice**: standard content policies.

## 10. Kindle Unlimited (KU) rules

Kindle Unlimited is Amazon's subscription program. If you enroll your ebook:

- **90-day Amazon exclusivity**: you cannot sell the ebook on other platforms during that window
- You earn from the **Global Fund** (per page read, ~$0.004 per page in 2026)
- Renewal is automatic every 90 days unless you opt out
- Paperbacks are NOT enrolled — only ebooks

Rule of thumb: **enroll in KU for the first 90 days** (great launch discoverability), then re-evaluate based on your genre. Romance and thrillers do well in KU; how-to guides often don't.

## 11. Publishing timeline

Once you click "Publish":

- **Ebook**: reviewed in 24 to 72 hours
- **Paperback**: reviewed in 72 hours + printing proof delay of 3-5 days
- **Hardcover**: 72 hours + 5-7 day printing timeline

Your book appears on Amazon.com automatically after review. It takes another 48-72 hours to appear in the correct browse categories.

## Quick pre-upload checklist

- [ ] Cover matches the trim size and includes bleed
- [ ] Interior PDF has correct margins for the page count
- [ ] Font is embedded in the PDF
- [ ] Title, subtitle, description meet character limits
- [ ] 7 keywords chosen, none repeat title words
- [ ] 2 categories picked
- [ ] AI disclosure selected honestly
- [ ] Price set inside the 70% royalty tier ($2.99–$9.99)
- [ ] KU enrollment decided
- [ ] Author account fully verified (tax + bank done)

Print this. Use it before every upload.

## Ready to build?

ProCreators exports **KDP-compliant PDFs** by default: correct trim sizes, correct margins, embedded fonts, print-safe color profiles. Start with the [Planner Maker](/dashboard/tools/planner-maker), [Journal Maker](/dashboard/tools/journal-maker), or [Ebook Creator](/dashboard/tools/ebook-maker) and skip the formatting headache.
`
  }
]
