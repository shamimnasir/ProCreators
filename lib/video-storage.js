...
class VideoStorageManager {
  ...
  async init() {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('[VideoStorage] IndexedDB initialized')
        resolve(this.db)
      }
  ...
  async saveVideo(projectId, videoFile, onProgress) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        console.log(`[VideoStorage] Saved video: ${videoFile.name} (${Math.round(videoFile.size / 1024 / 1024)}MB)`)
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        if (request.result) {
          ...
          console.log(`[VideoStorage] Loaded video: ${name}`)
  ...
  async saveProcessedVideo(projectId, blob, name = 'processed.mp4') {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        console.log(`[VideoStorage] Saved processed video (${Math.round(blob.size / 1024 / 1024)}MB)`)
        resolve({ success: true, videoId })
      }
  ...
  async saveProject(project) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        console.log(`[VideoStorage] Saved project: ${project.id}`)
  ...
  async deleteProject(projectId) {
    ...
    return new Promise((resolve, reject) => {
      ...
      transaction.oncomplete = () => {
        console.log(`[VideoStorage] Deleted project: ${projectId}`)
        resolve({ success: true })
      }
  ...
  async cleanupOldProjects() {
    ...
    if (deletedCount > 0) {
      console.log(`[VideoStorage] Cleaned up ${deletedCount} old projects`)
    }
