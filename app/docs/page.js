        ...
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="relative max-w-2xl">
            ...
            <Input
              ...
              className="pl-12 py-6 bg-white/10 border-white/20 text-foreground placeholder:text-gray-500 focus:border-[#7c3aed]"
            />
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {categories.map((category, index) => (
              <Card key={index} className="p-6 border-border bg-gradient-to-b from-white/5 to-transparent hover:border-[#7c3aed]/50 transition-all">
                  ...
                  {category.articles.map((article, aIndex) => (
                    <li key={aIndex}>
                      <a href="#" className="group flex items-start gap-2 text-sm hover:text-[#a78bfa] transition-colors">
                        ...
                        <div>
                          <div className="font-medium text-muted-foreground group-hover:text-[#a78bfa]">{article.title}</div>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <Card className="p-12 text-center bg-gradient-to-b from-[#7c3aed]/20 to-transparent border-[#7c3aed]/50">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Button variant="outline" className="border-white/20 text-muted-foreground hover:bg-white/10">
                Join Community
              </Button>
            </div>
          </Card>
