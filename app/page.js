...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e27] text-white overflow-x-hidden">
      ...
      <section className="py-20 bg-[#0a0e27]">
        <div className="container px-6">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Popular AI Tools</h2>
          </div>
          <div className="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto">
            {[
              ...
              <div 
                key={i}
                className="px-6 py-3 rounded-full bg-white/5 border border-white/10 hover:border-[#7c3aed]/50 hover:bg-white/10 transition-all cursor-pointer"
              >
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-[#0a0e27]/80 backdrop-blur-xl">
        <div className="container px-6 py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#features" className="text-gray-400 hover:text-white transition-colors text-sm">All Features</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Content Creators</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Marketing Teams</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Agencies</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Freelancers</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Educators</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">E-commerce</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Press Kit</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Partners</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Affiliate Program</Link></li>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              ...
              <Link href="#" className="text-gray-400 hover:text-white transition-colors text-sm">GDPR</Link>
