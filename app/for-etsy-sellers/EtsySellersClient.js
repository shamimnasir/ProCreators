...
const features = [
  'Planner interiors in A4, Letter, and A5 formats',
  'Coloring page sets (10, 25, 50, or 100 pages per set)',
  'Worksheet bundles for any subject or niche',
  'Journal interiors with unique prompts per page',
  'Cover design included with every product',
  'High-resolution PDF download for Etsy digital delivery',
]
