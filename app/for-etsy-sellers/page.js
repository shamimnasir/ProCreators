...
export const metadata = {
 ...
 description: 'Create Etsy-ready planners, journals, coloring pages, and worksheets with AI. Complete product in under 2 hours. High-res PDF download. First product free.',
 alternates: { canonical: 'https://procreators.io/for-etsy-sellers' },
 openGraph: {
 title: 'Create Etsy Printables 10x Faster With AI',
 description: 'ProCreators designs your complete Etsy printable product in under 2 hours. Download. List. Earn.',
 ...
 description: 'Complete Etsy-ready printable in under 2 hours. First product free.',
 },
}
