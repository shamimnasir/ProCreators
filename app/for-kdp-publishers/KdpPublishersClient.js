...
const features = [
 { icon: BookOpen,    title: 'KDP cover generator with auto spine calculation', body: 'Front, spine, and back in one tool. Spine width auto-calculated from your page count. 12+ marketplace presets (KDP paperback, Kindle, Etsy, socials) with exact pixel dimensions. No more rejected uploads.' },
 { icon: Pencil,      title: 'Ebook generator with full structure',              body: 'Pick a niche, pick a structure, and AI writes the full ebook. Title, TOC, introduction, chapters, conclusion, author bio. 5 cover styles × 3 typography sets. Auto-saved drafts so you never lose progress.' },
 { icon: LayoutGrid,  title: 'Interior page builder for journals, planners, coloring books', body: '10 planner types, 8 journal types, 5 KDP-accepted coloring book sizes. Auto-formatted for 6×9, 8.5×11, A4, and A5. 4-9 design themes per tool. Zero Canva work.' },
 { icon: Search,      title: 'Amazon listing writer with AI-detection bypass',    body: 'Title, 7 bullet points, description, and backend keywords, all Amazon algorithm optimized. Built-in AI Humanizer so your listing reads human and passes AI detection filters. Copy-paste ready.' },
 { icon: Star,        title: 'Every product ships with an Amazon-ready listing',  body: 'Ebook, cover, and Amazon listing copy generate together, in one workflow. No manual keyword research. No second tool. No copy-paste between apps.' },
 { icon: Download,    title: 'Print-ready 300 DPI PDF export every time',        body: 'No reformatting. No re-exporting. Download and upload straight to KDP. Correct margins, bleed settings, and spine width built in for every trim size.' },
]
