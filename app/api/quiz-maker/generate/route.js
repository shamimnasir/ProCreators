...
// Generate Quiz HTML for complex scripts (Bengali, Hindi, Arabic, etc.)
function generateQuizHTML(content, options) {
  const { 
    title, 
    authorName, 
    primaryColor = '#1e40af', 
...
<body>
  ...
  <div class="page">
    ...
    \${content.bonusQuestion && content.bonusQuestion.question ? \`
  ...
  \${includeAnswerKey ? \`
    ...
    <div class="page">
      ...
      \${content.bonusQuestion && content.bonusQuestion.answer ? \`
