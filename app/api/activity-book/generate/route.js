...
function stripEmojis(text) {
  if (!text) return ''
  // Comprehensive emoji removal - covers all Unicode emoji ranges including misc symbols
  return text.replace(/[\u{1F600}-\u{1F64F}]|[\u{1F300}-\u{1F5FF}]|[\u{1F680}-\u{1F6FF}]|[\u{1F1E0}-\u{1F1FF}]|[\u{2600}-\u{26FF}]|[\u{2700}-\u{27BF}]|[\u{1F900}-\u{1F9FF}]|[\u{1FA00}-\u{1FA6F}]|[\u{1FA70}-\u{1FAFF}]|[\u{FE00}-\u{FE0F}]|[\u{1F000}-\u{1F02F}]|[\u{2B50}-\u{2B55}]|[\u{203C}-\u{3299}]|[\u{00A9}-\u{00AE}]|[\u{2300}-\u{23FF}]|[\u{2460}-\u{24FF}]|[\u{25A0}-\u{25FF}]|[\u{2190}-\u{21FF}]/gu, '').trim()
}
