                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      <h2 className="text-2xl font-bold text-foreground">{item.quarter}</h2>
                      <span className={`px-4 py-1 rounded-full text-xs font-semibold bg-gradient-to-r ${getStatusColor(item.status)} text-foreground`}>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      {item.features.map((feature, fIndex) => (
                        <Card key={fIndex} className="p-6 bg-white/5 border-border hover:border-[#7c3aed]/50 transition-all">
